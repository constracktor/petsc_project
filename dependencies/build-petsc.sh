...
#${PYTHONPATH} configure --with-debugging=${DEBUGGING} --with-mpi-dir=$HOME/build/bin --download-fblaslapack --download-elemental --download-metis --download-parmetis --download-cmake && make all check