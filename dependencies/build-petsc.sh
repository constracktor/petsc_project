...
${PYTHONPATH} configure --with-fc=0 --with-language=cxx --with-debugging=${DEBUGGING} --with-mpi-dir=$HOME/build --download-f2cblaslapack --download-elemental --download-metis --download-parmetis --download-cmake && make all check